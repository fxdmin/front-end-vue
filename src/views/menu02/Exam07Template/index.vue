...
<template>
  <div class="card">
    ...
    <div class="card-body">
      <button class="btn btn-outline-success mr-2" @click="modalDialogTemplate=true"> Show Modal</button>
      <button class="btn btn-outline-success mr-2" @click="dialogA=true"> Show DialogA</button>
      <button class="btn btn-outline-success mr-2" @click="dialogB=true"> Show DialogB</button>
    </div>
