<template>
  <ul class="nav flex-column">
    ...
    <li class="nav-item mt-2">
      ...
      <router-link to="/menu01/exam03view" class="nav-link text-warning">중첩 라우터</router-link>
      <router-link to="/menu01/exam04view" class="nav-link text-warning">이름이 있는 라우트</router-link>
    ...
    <li class="nav-item mt-2">
      ...
      <router-link to="/menu02/exam05repeatbinding" class="nav-link text-warning">반복 바인딩</router-link>
    ...
    <li class="nav-item mt-2">
      ...
      <router-link to="/menu04/exam02eventemit" class="nav-link text-warning">자식에서 부모로 전달(event 방식)</router-link>
    ...
    <li class="nav-item mt-2">
      ...
      <router-link to="/menu07/exam01asynccontrol" class="nav-link text-warning">비동기 작업 도중 보여주는 스피너</router-link>
